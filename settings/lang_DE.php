<?php
  ...
  /* Header Nav */
        ...
        $tpl->assign('header_nav_li1', 'Analysieren');   
        $tpl->assign('header_nav_li2', 'Verbessern');   
        $tpl->assign('header_nav_li3', 'Verbinden');   
  ...
  /* Initialize :: Language Data */
     ...
     /* Administration :: Settings 
        ...
        $tpl->assign('set_visiters1', "Besucher: l�schen nach X min");
        $tpl->assign('set_visiters2', "Besucher: Neu z�hlen nach X min");                        
