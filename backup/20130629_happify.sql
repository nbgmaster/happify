...
--
-- Host: localhost
-- Generation Time: Jun 29, 2013 at 12:07 PM
...
--
-- Table structure for table `bd_scale_categories`
--
...
--
-- Dumping data for table `bd_scale_categories`
--
...
--
-- Table structure for table `bd_scale_items`
--
...
--
-- Dumping data for table `bd_scale_items`
--
...
--
-- Table structure for table `bd_scale_results`
--
...
--
-- Dumping data for table `bd_scale_results`
--
...
--
-- Table structure for table `da_scale_categories`
--
...
--
-- Dumping data for table `da_scale_categories`
--
...
--
-- Table structure for table `da_scale_items`
--
...
--
-- Dumping data for table `da_scale_items`
--
...
--
-- Table structure for table `da_scale_results`
--
...
--
-- Dumping data for table `da_scale_results`
--
...
(1, 1, 'managed to get to uni', '2012-06-02 00:00:00', ''),
(2, 1, 'met the funny oma again at Mc''Donalds', '2012-06-02 00:00:00', ''),
(3, 1, 'Trivia question of the day: aside from Yahveh, does the bible explicitly recognize the existence of other gods?', '2012-06-03 18:46:19', ''),
(4, 1, 'Hey everyone,\r\nlittle reminder: the general meeting will take place tomorrow!\r\nThe meeting will take place in DE03 (UZA4). After the meetings, tables are reserved at Summerstage.', '2012-06-03 18:46:19', ''),
(9, 1, 'that I went jogging AND to the gym today (and in the end without getting headache)', '2012-06-04 00:17:56', ''),
(10, 1, 'used HAIRSPRAY today!! how awesome my hair looks now', '2012-06-05 00:23:27', ''),
(11, 1, 'MIB3 was fun', '2012-06-07 01:26:11', ''),
(12, 1, 'had a nice park meeting with Sylwia. She also helped me to understand what matter in real friendships. It felt good to socialize a bit :-)', '2012-06-07 21:38:02', ''),
(13, 1, 'it was nice to meet Doina today after haven''t seen her for a long time', '2012-06-08 21:06:11', ''),
(14, 1, 'Germany: first win against Portugal!!', '2012-06-09 23:39:00', ''),
(15, 1, 'Djoker comeback unbelievable. but rain delay probably not good for him. to be continued tmrw', '2012-06-10 20:47:45', ''),
(16, 1, 'low expectations = the key to happiness', '2012-06-17 00:14:43', ''),
(17, 1, 'came back from the workshop. had a good time! Adriana is interesting ;-)', '2012-06-17 00:14:43', ''),
(18, 1, 'muscles are starting to be slightly visible again - motivating!', '2012-06-27 00:02:22', ''),
(19, 1, 'I do not know why, but I really had a date with Adriana and we made out - wow!', '2012-07-06 00:13:17', ''),
(20, 1, 'I''m happy! Adriana gives me so much confidence back, no matter how it ends. I''m feeling good these days, and who had thought that a couple of weeks ago... ;-)', '2012-07-12 21:06:58', ''),
(21, 1, 'first work week ran by so fast... lot of meetings... but so far so good :-)', '2012-08-17 22:28:39', ''),
(22, 1, 'I need to get to know this women in the office!!!!', '2012-08-30 21:53:30', ''),
(45, 1, 'today I felt amazing; confident; I even asked the waitress Paula at flanagans for her phone number. I hope I can keep up this positive attitude', '2012-09-11 11:18:44', ''),
(46, 1, 'master thesis submitted!!555', '2012-09-13 11:19:14', ''),
(62, 1, 'I''m so excited to have my date with Eva! She is really cute and nice!! But let''s just enjoy the day and then we''ll see.', '2013-01-17 23:46:10', ''),
(61, 1, 'I don''t need a girl to be happy!', '2012-11-15 00:12:07', ''),
(60, 1, 'surgery survived...now we''ll see... so far it looks good!', '2012-10-13 14:42:44', ''),
(183, 1, 'Tell yourself something nice about the day', '2013-06-09 21:08:54', '4fd3d4f49126b07484fd60d987aed237.jpg'),
(65, 1, 'Let''s get the PUA thing started!', '2013-02-03 13:48:07', ''),
(66, 1, 'I know myself! I''m introverted and prefer to spend time with myself. I''m on the right track!', '2013-02-09 11:36:57', ''),
(67, 1, 'http://www.airpano.com woohoo!', '2013-02-09 15:08:35', ''),
(68, 1, 'Candida diet day 1: so far so good, ate salad from vapiano (5 mini pieces of meat - ridiculous, and I had to remove the cheese), and fish later. prepared my breakfast for tomorrow (eggs + vegetables) 29 days to go :-)', '2013-05-01 23:26:58', ''),
(69, 1, 'Candida diet day 2: horrible headache!! Feeling energyless as expected. but tongue gets better and spill test was positive so I need to stay positive!', '2013-05-03 16:12:42', ''),
(70, 1, 'Candida diet day 3: feel better, but I ate chicken mcnuggets :/ 30g kohlenhydrate is probably too much I guess. Need to have self-made meat only. tmrw go to passau to get my drugs, ridiculous...', '2013-05-03 16:16:28', ''),
(184, 1, 'woohoo, happify first release version seems managable after all. keep on going!', '2013-06-10 23:58:32', ''),
(166, 1, 'Tell yourself something nice about the day: http://www.script-tutorials.com/pinterest-like-script-step-2/ jooo, check it out999jkljjhkhjkhj', '2013-06-08 21:54:35', ''),
(170, 1, 'Tell yourself something nice about the day', '2013-06-09 00:26:59', '9c4a43758838d43428943eaeee5fc320.jpg'),
(186, 1, 'Tell yourself something nice about the day', '2013-06-20 22:56:59', 'e80106007c9ee7ca438560f715b7b7c8.jpg'),
(187, 1, 'Tell yourself something nice about the day', '2013-06-20 22:58:52', '7fb19026eacb0d0f0bfde88e4b2c2b42.jpg'),
(188, 1, 'Tell yourself something nice about the day', '2013-06-20 22:59:34', 'e9b5662f0a86cfaed832023604908e75.jpg'),
(189, 1, 'hot!!!', '2013-06-20 23:01:27', 'b2c9aa7ef38842ca0a485c65e89e3f4b.jpg'),
(190, 1, 'Tell yourself something nice about the day', '2013-06-28 22:10:01', ''),
(191, 1, 'Tell yourself something nice about the day222', '2013-06-28 22:12:32', '');

-- --------------------------------------------------------

--
-- Table structure for table `distorted_thoughts`
--
...
--
-- Dumping data for table `distorted_thoughts`
--
...
--
-- Table structure for table `happifiers`
--
...
--
-- Dumping data for table `happifiers`
--
...
(14, 'Don''t sweat the small stuff', 'Happy people ask themselves, "Will this problem matter a year from now?" They understand that life''s too short to get worked up over trivial situations. Letting things roll off your back will definitely put you at ease to enjoy the more important things in life.', 0),
(15, 'Speak well of others', 'Being nice feels better than being mean. As fun as gossiping is, it usually leaves you feeling guilty and resentful. Saying nice things about other people encourages you to think positive, non-judgmental thoughts.', 0),
(16, 'Never make excuses', 'Benjamin Franklin once said, "He that is good for making excuses is seldom good for anything else." Happy people don''t make excuses or blame others for their own failures in life. Instead, they own up to their mistakes and, by doing so, they proactively try to change for the better.', 0),
(17, 'Get absorbed into the present', 'Happy people don''t dwell on the past or worry about the future. They savor the present. They let themselves get immersed in whatever they''re doing at the moment. Stop and smell the roses.', 0),
(18, 'Wake up at the same time every morning', 'Have you noticed that a lot of successful people tend to be early risers? Waking up at the same time every morning stabilizes your circadian rhythm, increases productivity, and puts you in a calm and centered state.', 0),
(19, 'Avoid social comparison', 'Everyone works at his own pace, so why compare yourself to others? If you think you''re better than someone else, you gain an unhealthy sense of superiority. If you think someone else is better than you, you end up feeling bad about yourself. You''ll be happier if you focus on your own progress and praise others on theirs.', 0),
(20, 'Choose friends wisely', 'Misery loves company. That''s why it''s important to surround yourself with optimistic people who will encourage you to achieve your goals. The more positive energy you have around you, the better you will feel about yourself.', 0),
(21, 'Never seek approval from others', 'Happy people don''t care what others think of them. They follow their own hearts without letting naysayers discourage them. They understand that it''s impossible to please everyone. Listen to what people have to say, but never seek anyone''s approval but your own.', 0),
(22, 'Take the time to listen', 'Talk less; listen more. Listening keeps your mind open to others'' wisdoms and outlooks on the world. The more intensely you listen, the quieter your mind gets, and the more content you feel.', 0),
(23, 'Nurture social relationships', 'A lonely person is a miserable person. Happy people understand how important it is to have strong, healthy relationships. Always take the time to see and talk to your family, friends, or significant other.', 0),
(24, 'Meditate', 'Meditating silences your mind and helps you find inner peace. You don''t have to be a zen master to pull it off. Happy people know how to silence their minds anywhere and anytime they need to calm their nerves.', 0),
(25, 'Eat well', 'Junk food makes you sluggish, and it''s difficult to be happy when you''re in that kind of state. Everything you eat directly affects your body''s ability to produce hormones, which will dictate your moods, energy, and mental focus. Be sure to eat foods that will keep your mind and body in good shape.', 0),
(26, 'Exercise', 'Studies have shown that exercise raises happiness levels just as much as Zoloft does. Exercising also boosts your self-esteem and gives you a higher sense of self-accomplishment.', 0),
(27, 'Live minimally', 'Happy people rarely keep clutter around the house because they know that extra belongings weigh them down and make them feel overwhelmed and stressed out. Some studies have concluded that Europeans are a lot happier than Americans are, which is interesting because they live in smaller homes, drive simpler cars, and own fewer items.', 0),
(28, 'Tell the truth', 'Lying stresses you out, corrodes your self-esteem, and makes you unlikeable. The truth will set you free. Being honest improves your mental health and builds others'' trust in you. Always be truthful, and never apologize for it.', 0),
(29, 'Establish personal control', 'Happy people have the ability to choose their own destinies. They don''t let others tell them how they should live their lives. Being in complete control of one''s own life brings positive feelings and a great sense of self-worth.', 0),
(30, 'Accept what cannot be changed', 'Once you accept the fact that life is not fair, you''ll be more at peace with yourself. Instead of obsessing over how unfair life is, just focus on what you can control and change it for the better.', 0);
...
(1, 'f561aaf6ef0bf14d4208bb46a4ccb3ad', 'stefan@happify.com', '3a2b37336664ede535b20c76b315a0f1', '0000-00-00 00:00:00', 'Stefan', 'm', '1985-06-18', 'DE', 'DE', 'Become an inspiring CEO of a start-up within the next 5 years', '', '1,2,3,4', 675992449, 'Stefan Richter', '1,2,3,5', 'EN', '2013-06-29 12:03:18', 0, '', 8, 2012, 0, 'a:7:{i:0;i:7;i:1;i:-7;i:2;i:-9;i:3;i:-9;i:4;i:9;i:5;i:4;i:6;i:-1;}'),
...
(506, '96134f0514017c98db08150775662254', 'stefan@wiflash.comr', '84a9de180e0ea617561ae8abb256084f', '2011-08-23 01:21:15', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '6d1403ebde5a02e347efff5c94153ec5', 0, 0, 0, '');
INSERT INTO `users` (`ID`, `UserToken`, `UserEmail`, `UserPass`, `RegDate`, `firstname`, `gender`, `birthday`, `nationality`, `residence`, `description`, `personal_goal`, `flash_categories_visible`, `fb_ID`, `fb_name`, `sections_public`, `language`, `last_online_time`, `trigger_friends`, `activation_code`, `diary_start_month`, `diary_start_year`, `bd_latest_score`, `da_latest_score`) VALUES
(507, '50bdacec67c3db943c1eba8ac39a9b69', 'stefan@wiflash.come', 'f5d1278e8109edd94e1e4197e04873b9', '2011-08-23 01:27:44', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '8f5ede1cb71a454f6116057208843a7a', 0, 0, 0, ''),
(508, '13140567474e52ea2b23feb', 'tester@test,de', 'f5d1278e8109edd94e1e4197e04873b9', '2011-08-23 01:45:47', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '814cf24d27bc82ecdb6bc7ec80548da4', 0, 0, 0, ''),
(509, '13140570694e52eb6df164f', 'stefan@wiflash.comhh', 'd40c2c1557cdcb1f10ac8a599a875d5c', '2011-08-23 01:51:09', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, 'd708b074b40e000b94e9e274758acaf7', 0, 0, 0, ''),
(510, '13140575844e52ed70736d2', 'stefan@wiflash.comeee', 'f5d1278e8109edd94e1e4197e04873b9', '2011-08-23 01:59:44', '', 'm', '1956-07-06', 'AS', 'AO', '', '', '', 0, '', '', 'en', '2011-08-23 13:12:17', 0, '', 0, 0, 0, ''),
(511, '13140603364e52f830b8c4e', 'stefan@wiflash.comxx', 'f5d1278e8109edd94e1e4197e04873b9', '2011-08-23 02:45:36', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '7ed354cf82624fa49cbd136c33f38f6d', 0, 0, 0, ''),
(512, 'huih', 'dd', 'huih', '2012-09-01 20:31:46', 'hui', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, 'huih', 0, 0, 0, ''),
(513, 'huih2', 'dd2', 'huih', '2012-09-01 20:35:30', 'hui', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, 'huih', 0, 0, 0, ''),
(514, 'huih3', 'dd3', 'huih', '2012-09-01 20:36:06', 'hui', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, 'huih', 0, 0, 0, ''),
(515, '1346524669504255fd16610', 'huih', '827ccb0eea8a706c4c34a16891f84e7b', '2012-09-01 20:37:49', 'ghfghf', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '31ba998d3425f9839b707fc53cb1e6aa', 0, 0, 0, ''),
(516, '134652470750425623df2cd', 'gzuguzg', 'd41d8cd98f00b204e9800998ecf8427e', '2012-09-01 20:38:27', '', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '44508299c4d1c1f3460b61b040fe8893', 0, 0, 0, ''),
(517, '1346524787504256733c0a2', 'hjkhkjh', '827ccb0eea8a706c4c34a16891f84e7b', '2012-09-01 20:39:47', 'hjui', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '13ea3959731b34e0d7d72da8fda8f90a', 0, 0, 0, ''),
(518, '1346525542504259666e92c', 'stefan@happify.cm', '827ccb0eea8a706c4c34a16891f84e7b', '2012-09-01 20:52:22', 'jkoii', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '6f8a74f6880d7e79b8ce882ad59e27f5', 0, 0, 0, ''),
(545, '13469529835048df1799989', 'de.stefan.richter@gmail.com', '3a2b37336664ede535b20c76b315a0f1', '2012-09-06 19:36:23', 'jkljklj', 'm', '0000-00-00', '', '', '', '', '', 0, '', '', 'en', '0000-00-00 00:00:00', 0, '', 0, 0, 0, '');
