...
--
-- Host: localhost
-- Erstellungszeit: 07. Jul 2013 um 02:01
...
CREATE TABLE IF NOT EXISTS `blog` (
  ...
  `fb_likes` int(10) NOT NULL,
  `fb_comments` int(10) NOT NULL,
  PRIMARY KEY (`ID`),
...
(1, 1, 'managed to get to uni', '2012-06-02 03:28:21', ''),
(2, 1, 'met the funny oma again at Mc''Donalds', '2012-06-02 01:20:20', ''),
...
(19, 1, 'I really had a date with Adriana and we made out - wow!', '2012-07-05 22:13:17', ''),
...
(184, 1, 'woohoo, happify first release version seems managable after all. keep on going!666eeee', '2013-06-10 21:58:32', ''),
...
(1, 1, 'Build Happify.me', '', 60, '2012-01-16 00:00:00', '0000-00-00 00:00:00', 0),
(3, 1, 'Talk to at least 20 girls until the end of the year', '', 40, '2012-09-07 00:00:00', '0000-00-00 00:00:00', 0),
...
(1, 'Be yourself', '', 1),
(33, 'Start habits and routines', '', 0),
(31, 'Set goals', '', 0),
(32, 'Remove distorted thoughts', '', 0),
...
(7, 'Avoid negative thoughts, think only positive', 'Focus on the positive events of your life --> happy diary', 7),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `bd_latest_score` smallint(3) NOT NULL DEFAULT '500',
...
(546, 'vvvjv', 'bhjbjhb', '', '2013-07-06 22:44:53', '', '', '0000-00-00', '', '', '', '', '', 0, '', '', '', '0000-00-00 00:00:00', 0, '', 0, 0, 0, '');
